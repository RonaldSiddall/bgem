...
setuptools.setup(
    ...
    packages=['bgem', 'bgem.polygons', 'bgem.bspline', 'bgem.gmsh', 'bgem.external', 'bgem.geometry', 'bgem.stochastic', 'bgem.core', 'bgem.upscale', 'bgem.tests'], #setuptools.find_packages(where='src'),
    package_dir={'': 'src'},
